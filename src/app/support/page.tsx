...
export default function Support() {
  ...
  return <main className="page-shell support">
    <section className="support-card">
      <div className="eyebrow">Help desk</div>
      <h1>How can we help?</h1>
      <p>Tell us what is getting in your way. Our team will be in touch within one working day.</p>
      <div className="support-note">
        <b>Looking for a quick answer?</b>
        <span>Visit your workspace to review project and sprint guidance.</span>
      </div>
    </section>
